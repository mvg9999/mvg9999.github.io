...
Every VC fund operates differently. They have different timelines and different IC structures. You should aim to spend 5 minutes in your first meeting understanding how they operate; the code for this is "How does your process work?". You won't learn everything, but you should try to understand:
...
It's hard to say a ton here because each process is so different, but a few minor notes:
